/// “естирование методов класса Graph
/// @author Ѕудаев √.Ѕ.
#include "pch.h"
...
namespace UnitTestGraph
{
    ...
    public:
        ...
        TEST_METHOD(TestMethod_MoveConstructor)
        {
            ...
            vector<int> a;
            /// ѕроход итератором чтобы проверить второй граф после перемещени€ первого
            for (Graph<int>::Iterator<int> it = g1.begin(); it != g1.end(); ++it) {
                a.push_back(*it);
            }
        ...
        /// <summary>
        /// тестирование оператора присваивани€ копированием
        /// </summary>
        ...
        /// <summary>
        /// тестирование оператора присваивани€ перемещением
        /// </summary>
        ...
        TEST_METHOD(TestMethod_DeleteEdge)
        {
            ...
            // удаление несуществующего ребра не приводит к изменени€м
            g1.DeleteEdge(2, 2);
            Assert::IsTrue(g1.NumberOfEdges() == 3);
            Assert::IsTrue(g1.NumberOfVertices() == 5);
        ...
        /// <summary>
        /// тестирование веса дуги (измен€етс€ при задании дуги заново)
        /// </summary>
        ...
        /// <summary>
        /// тестирование соседей, с которыми есть пр€ма€ св€зь
        /// </summary>
        ...
        /// <summary>
        /// тест кратчайшего пути
        /// </summary>
        TEST_METHOD(TestMethod_FindShortestDistances)
        {
            // —оздание графа
            Graph<int> graph;

            // ƒобавление вершин и ребер в граф
            ...
            //Assert::AreEqual<int>(way.size(), 4);
            //Assert::AreEqual<int>(way[0], 0);
            //Assert::AreEqual<int>(way[1], 2);
            //Assert::AreEqual<int>(way[2], 3);
            //Assert::AreEqual<int>(way[3], 6);
        }
